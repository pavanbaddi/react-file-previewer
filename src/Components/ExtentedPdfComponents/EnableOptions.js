...
export default function EnableOptions({ printPlugin, zoomPlugin, features, setFeatures }) {
    ...
    const Options = [
        ...
        },
        {
            "title": "Print",
            "render": () => {
                return <printPlugin.Print>
                    {(props) => {
                        return <button type="button" onClick={() => props.onClick()} >Print</button>
                    }}
                </printPlugin.Print>
            }
        },
